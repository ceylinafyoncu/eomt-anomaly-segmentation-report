...
For anomaly segmentation, we compare ERFNet and EoMT models using four post-hoc scoring methods which are MSP, MaxLogit, MaxEntropy, and \rev{RbA (Rejected by All)} on five different datasets. 
 \rev{In the revised version, RbA is implemented as the negative total known-class mass over the EoMT semantic score map.}
